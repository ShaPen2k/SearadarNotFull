...
/**
 * Класс является частью системы обработки сообщений с морских радаров.
 * Класс-конвертер Mr231_3Converter реализует интерфейс SearadarExchangeConverter.
 * Он отвечает за преобразование входящих сообщений в объекты SearadarStationMessage на основе разных типов сообщений.
 * <p>
 * Класс Mr231_3Converter содержит методы для разбора входящего сообщения, извлечения актуальной информации и создания
 * соответствующих объектов SearadarStationMessage, таких как TrackedTargetMessage и RadarSystemDataMessage.
 * <p>
 * Класс имеет возможность обрабатывать типы сообщений "TTM" и "RSD" и конвертировать их соответствующим образом.
